...
OWNER_VIDEO_UPSCALE = "video_upscale"
OWNER_VIDEO_BACKGROUND_REMOVAL = "video_background_removal"
OWNER_VIDEO_TEXT_EDIT = "video_text_edit"
VALID_OWNER_TYPES = frozenset({
    OWNER_VOICE_CLONE, OWNER_TRANSCRIPTION, OWNER_VIDEO_GENERATION,
    OWNER_VIDEO_UPSCALE, OWNER_VIDEO_BACKGROUND_REMOVAL, OWNER_VIDEO_TEXT_EDIT,
})
